...
try:    
    ...
    for i in range(3):
       ...
       # obj = bpy.ops.mesh.primitive_cube_add(location=(x, y, z))
        ...
        #Monke Wizard 1
        obj1 = bpy.ops.mesh.primitive_cube_add(location=(0,0,0))
        obj2 = bpy.ops.mesh.primitive_cone_add(location=(0,-0.2,5.8))
        obj3 = bpy.ops.mesh.primitive_monkey_add(location=(0,-0.5,4))
        obj4 = bpy.ops.mesh.primitive_cylinder_add(location=(0,0,2))
        obj5 = bpy.ops.mesh.primitive_uv_sphere_add(location=(0,0,3))
        #Monke Wizard 2
        obj1 = bpy.ops.mesh.primitive_cube_add(location=(3,0,0))
        obj2 = bpy.ops.mesh.primitive_cone_add(location=(3,-0.2,5.8))
        obj3 = bpy.ops.mesh.primitive_monkey_add(location=(3,-0.5,4))
        obj4 = bpy.ops.mesh.primitive_cylinder_add(location=(3,0,2))
        obj5 = bpy.ops.mesh.primitive_uv_sphere_add(location=(3,0,3))
        #Monke Wizard 3
        obj1 = bpy.ops.mesh.primitive_cube_add(location=(-3,0,0))
        obj2 = bpy.ops.mesh.primitive_cone_add(location=(-3,-0.2,5.8))
        obj3 = bpy.ops.mesh.primitive_monkey_add(location=(-3,-0.5,4))
        ...
        obj5 = bpy.ops.mesh.primitive_uv_sphere_add(location=(-3,0,3))
        #Monke Wizard 4
        obj1 = bpy.ops.mesh.primitive_cube_add(location=(-6,0,0))
        obj2 = bpy.ops.mesh.primitive_cone_add(location=(-6,-0.2,5.8))
        obj3 = bpy.ops.mesh.primitive_monkey_add(location=(-6,-0.5,4))
        obj4 = bpy.ops.mesh.primitive_cylinder_add(location=(-6,0,2))
        obj5 = bpy.ops.mesh.primitive_uv_sphere_add(location=(-6,0,3))
    ...
    for result in bpy.data.collections:
        if result.name == collection.name:
            for object in result.objects:
                ...
                #obj4.rotation_euler = (radians(30), radians(30), radians(30)) # Rotation
                #console(f"Rotation => x:{obj4.rotation_euler.x}, y:{obj4.rotation_euler.y}, x:{obj4.rotation_euler.z}")
                #obj4.keyframe_insert(data_path="rotation_euler", frame=frames + offset, group="Rotation")
