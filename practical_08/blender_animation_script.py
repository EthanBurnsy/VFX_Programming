...
try:    
    ...
    #Modifier 1
    object.modifiers.new('Scripted_Skin', 'SKIN') #Add skin modifier
    object.modifiers['Scripted_Skin'].branch_smoothing = 0.75

    #Modifier 2
    object.modifiers.new('Scripted_Screw', 'SCREW') #Add screw modifier
    object.modifiers['Scripted_Screw'].angle = 6.28
